...
import { Ph as PhIcon, Us as UsIcon, Ru as RuIcon } from '../../../icons/flags/4x3';
            ...
            >
                <Toolbar>
                    <Grid container spacing={8} alignItems="center">
                        ...
                        {monitoringEnabled && (
                            <Grid item className={classes.navLinkPadder}>
                                <Tooltip
...
const styles = theme => ({
    ...
    menuButton: {
        marginLeft: -theme.spacing.unit+' !important',
    },
