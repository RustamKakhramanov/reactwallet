...
function Sidebar(props) {
    ...
    const linkGroups = [
        ...
        // },
        {
            name: Lang.get('navigation.wallet.cards'),
            id: 'resources',
            links: [
                {
                    name: Lang.get('navigation.wallet.layout_create'),
                    icon: (
                        <Tooltip
                            title={
                                minimized ? Lang.get('navigation.wallet.layout_create') : ''
                            }
                        >
                            <Brush />
                        </Tooltip>
                    ...
                    path: NavigationUtils.route(
                        'backoffice.wallet.layout.create',
                    ),
                },
                {
                    name: Lang.get('navigation.wallet.layouts'),
                    icon: (
                        <Tooltip
                            title={
                                minimized ? Lang.get('navigation.wallet.layouts') : ''
                            }
                        >
                            <CreditCard />
                        </Tooltip>
        ...
        },
        {
            ...
            links: [
                {
                    name: Lang.get('navigation.register_client'),
                    icon: (
                            <Tooltip
                        title={
                            minimized ? Lang.get('navigation.register_client') : ''
                        }
                        >
                        <AccountBox />
                        </Tooltip>
                ...
                {
                        name: Lang.get('navigation.clients_list'),
                        icon: (
                            <Tooltip
                        title={
                            minimized ? Lang.get('navigation.clients_list') : ''
                        }
                        >
                        <PeopleIcon />
                        </Tooltip>
                    ...
                    path: NavigationUtils.route(
                        'backoffice.clients.list',
                    ),
                },
            ],
        },
        {
            name: Lang.get('navigation.settings'),
            id: 'options',
            links: [
                {
                    name: Lang.get('navigation.loyalty_system'),
                    icon: (
                                <Tooltip
                                    title={
                                        minimized ? Lang.get('navigation.roles') : ''
