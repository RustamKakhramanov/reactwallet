...
function Profile(props) {
                    ...
                    {({
                        ...
                        <Form>
                            ...
                            <TextField
                                id="firstname"
                                name="firstname"
                                label= {Lang.get('content.firstname')}
                            ...
                            <TextField
                                id="middlename"
                                name="middlename"
                                label={Lang.get('content.middlename')}
                            ...
                            <TextField
                                id="lastname"
                                name="lastname"
                                label={Lang.get('content.lastname')}
                            ...
                            <TextField
                                ...
                                label= {Lang.get('content.organization_name')}
                            ...
                            >
                                <MuiPickersUtilsProvider utils={MomentUtils}>
                                    <DatePicker
                                        id="birthdate"
                                        name="birthdate"
                                        label={Lang.get('content.birthdate')}
                            ...
                            <TextField
                                id="address"
                                name="address"
                                label={Lang.get('content.address')}
                            ...
                            >
                                ...
                                <Typography color="inherit"> {Lang.get('actions.update')}</Typography>
                            </Button>
                        </Form>
                    )}
                </Formik>
    ...
    return (
        <Layout {...other} pageTitle={Lang.get('content.profile')} message={message}>
            {renderBody}
        </Layout>
    );
}
