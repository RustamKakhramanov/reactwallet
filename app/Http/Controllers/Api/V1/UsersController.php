...
class UsersController extends Controller
{
    ...
    public function store(Request $request) : JsonResponse
    {
        $request->validate([
            ...
            'organization_name' => 'required_if:step,0|string|max:255',
        ...
        $user = User::create([
            ...
            'organization_name' => ($organization_name= $request->input('organization_name')),
    ...
    protected function paginatedQuery(Request $request) : LengthAwarePaginator
    {
        ...
        if ($organization_name = $request->input('organization_name')) {
            $this->filter($users, 'organization_name', $organization_name);
        }
